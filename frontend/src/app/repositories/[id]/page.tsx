...
const STAFFING_DATA = [
    {
        ...
        level: "Mid-Level",
        initials: "MF",
        skills: ["< > React", "TypeScript", "Material-UI (MUI)", "JavaScript", "Vitest", "i18next"],
        fte: "0.14 FTE (300 hours/year, 14% of standard year)",
        description: "This role focuses on frontend development, general application logic, and testing. AI coding assistants greatly accelerate development and debugging, enabling a mid-level developer to efficiently manage a broad scope despite dedicating only a fraction of their annual hours to this project. This individual is a full-time employee, dedicating the remainder of their annual hours (approx. 1780 hours) to other projects."
    },
    {
        id: 2,
        title: "Mid-Level Backend/DevOps Developer",
        level: "Mid-Level",
        initials: "MB",
        skills: ["< > Node.js", "TypeScript", "Docker", "Axios", "npm"],
        fte: "0.14 FTE (300 hours/year, 14% of standard year)",
        description: "Responsible for backend services, API integrations, and infrastructure maintenance. AI tools assist in navigating Node.js complexities and Docker configurations, empowering a mid-level developer to handle these tasks effectively with limited dedicated project hours. This individual is a full-time employee, dedicating the remainder of their annual hours (approx. 1780 hours) to other projects."
    }
];

const TECHNOLOGIES_DATA = [
    { name: 'React', fte: 378.6, commits: 422, complexity: 3.4, color: '#3b82f6' },
    { name: 'TypeScript', fte: 301.9, commits: 392, complexity: 3.3, color: '#64748b' },
    { name: 'Material-UI (MUI)', fte: 288.3, commits: 337, complexity: 3.5, color: '#10b981' },
    { name: 'Node.js', fte: 88.3, commits: 45, complexity: 3.8, color: '#f59e0b' },
    { name: 'npm', fte: 84.5, commits: 66, complexity: 2.2, color: '#ef4444' },
    { name: 'i18next', fte: 83.5, commits: 100, complexity: 3.7, color: '#8b5cf6' },
    { name: 'Vitest', fte: 81.3, commits: 100, complexity: 3.3, color: '#06b6d4' },
    { name: 'JavaScript', fte: 69.5, commits: 102, complexity: 3.3, color: '#84cc16' },
    { name: 'Axios', fte: 63.6, commits: 50, complexity: 4.7, color: '#65a30d' },
    { name: 'Docker', fte: 56.7, commits: 74, complexity: 3.3, color: '#ec4899' },
];
...
export default function RepositoryDetailPage({
    ...
    useEffect(() => {
        ...
        if (savedTabs) {
            ...
            setVisibleTabs({
                ...
                'pull-requests': true // wait, PRs tab? checking mapped tabs...
            });
        }
    }, []);
    ...
    const [chatHistory, setChatHistory] = useState([
        { id: '1', title: "Generate an Image: Show t...", text: "Show the folder structure and how images are generated.", date: "12.12.2025" },
        { id: '2', title: "How is OIDC configured", text: "Explain the OIDC configuration in this repository.", date: "12.12.2025" }
    ]);
    ...
    const [featureRequests, setFeatureRequests] = useState([
        {
            id: '1',
            title: "Settings Page & Notifications",
            description: "I want to create a settings page where users can configure their notification preferences (email, sms, push) and also update their profile picture.",
            date: "Generated 2 mins ago",
            status: "Generated",
            complexity: "low",
            type: "enhancement",
            summary: "This feature adds a comprehensive settings page allowing users to manage notification channels and profile settings.",
            identifiedFiles: ["src/app/settings/page.tsx", "src/components/ui/switch.tsx"],
            prompt: "Please implement a settings page at /settings..."
        },
        {
            id: '2',
            title: "Dark Mode Toggle",
            description: "Add a dark mode toggle to the navigation bar.",
            date: "Yesterday",
            status: "Generated",
            complexity: "low",
            type: "feature",
            summary: "Implement theme switching functionality with persistence.",
            identifiedFiles: ["src/components/Navbar.tsx", "src/hooks/useTheme.ts"],
            prompt: "Implement a theme toggle..."
        }
    ]);
    ...
    // Code Flows State
    const [codeFlows, setCodeFlows] = useState([
        { id: '1', title: 'Run Management Creation Flow', description: 'What is the flow of creating a new run? From creation to save call?', date: '11.12.2025', status: 'completed' }
    ]);
                ...
                <div className="p-8">
                        ...
                        <div className="space-y-8 animate-in fade-in duration-300">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <Card className="relative overflow-hidden border-none shadow-sm ring-1 ring-gray-100">
                                    ...
                                    <CardContent className="pt-8 text-right">
                                        ...
                                        <div className="text-4xl font-bold text-gray-900 mt-1">2685.5</div>
                                ...
                                <Card className="relative overflow-hidden border-none shadow-sm ring-1 ring-gray-100">
                                    ...
                                    <CardContent className="pt-8 text-right">
                                        ...
                                        <div className="text-4xl font-bold text-gray-900 mt-1">2</div>
                            ...
                            <Card className="bg-gradient-to-r from-red-50 to-white border border-red-100">
                                <CardContent className="p-8">
                                    <div className="flex justify-between items-center mb-6">
                                        ...
                                        <span className="bg-red-500 text-white text-[10px] font-extrabold px-3 py-1 rounded-md uppercase tracking-wider">Score: 7/10</span>
                                    </div>
                                    <p className="text-sm text-gray-600 leading-relaxed font-medium">
                                        This project utilizes a modern and comprehensive frontend stack with a strong emphasis on React, TypeScript, and a rich set of UI/UX libraries. The integration of various tools for linting, formatting, testing, and API generation adds to the complexity. Dockerization indicates a structured deployment approach.
                                    </p>
                                </CardContent>
                            </Card>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 border-t border-gray-100 pt-8">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-3xl font-extrabold text-red-600 flex items-baseline gap-1.5">
                                                    30% <span className="text-sm text-red-500 font-bold tracking-tight">(~101 days)</span>
                                                </div>
                                            </div>
                                            <div>
                                                <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">AI-Adjusted Effort</h4>
                                                <div className="text-3xl font-extrabold text-gray-900">1880h</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm ring-1 ring-gray-900/5 hover:shadow-md transition-shadow relative overflow-hidden group">
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            ...
                                            <div className="text-4xl font-extrabold text-gray-900">287</div>
                                ...
                                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm ring-1 ring-gray-900/5 hover:shadow-md transition-shadow relative overflow-hidden group">
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            ...
                                            <div className="text-4xl font-extrabold text-gray-900">873</div>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm ring-1 ring-gray-900/5 p-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <ul className="space-y-4">
                                        {[
                                            { title: "Mitigate Key Contributor Risk", text: "Prioritize comprehensive knowledge transfer from starks (63% of dev hours) on core architecture, complex features, and multi-target CI/CD deployments to mitigate significant single-point-of-failure risk." },
                                            { title: "Frontend & DevOps Expertise", text: "Ensure the transition team has strong expertise in React, TypeScript, Material-UI, and complex CI/CD pipelines (GitHub Actions, Docker, Nginx, AWS/Azure/Porsche/Mercedes deployments)." },
                                            { title: "Deep Dive into Architectural Shifts", text: "Focus knowledge transfer on major architectural changes like Zustand to contexts, refactoring API service facade restructuring, and dynamic Nginx/OAuth2 proxy configurations." },
                                            { title: "Leverage AI for Boilerplate & Code Comprehension", text: "Utilize AI coding assistants to accelerate boilerplate generation for React/MUI components, Node.js API endpoints, TypeScript definitions, and to rapidly understand existing code patterns." },
                                            { title: "Estimated FTE Savings with AI", text: "Expect AI coding assistants to reduce the transition team's initial ramp-up time and common coding task effort by 15-20%, leading to faster productivity." },
                                            { title: "Strategic AI Application", text: "Deploy AI for standard technology tasks (React, TypeScript, Node.js, basic CI/CD scripting) but rely on human expertise for complex domain-specific integrations (Zephyr Scale, AI model APIs) and critical architectural decisions." },
                                            { title: "Review Breaking Changes", text: "Thoroughly review all identified breaking changes (API contracts, DTOs, NestJS upgrades) from the monthly summaries to anticipate necessary adjustments during transition." }
                                        ].map((rec, i) => (
                            ...
                            <div className="flex items-center gap-4 border-t border-gray-100 pt-8">
                                ...
                                <div className="flex items-center gap-2 px-3 py-1.5 bg-sky-50 border border-sky-100 rounded-lg">
                                    ...
                                    <span className="text-[10px] font-extrabold text-sky-800 uppercase tracking-widest">Mixed Development Project</span>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === "feature-map" && (
                        <div className="p-8 space-y-6 animate-in fade-in duration-300">
                            <div className="bg-[#f6f8fa] border border-gray-200 rounded-xl p-12 text-center border-dashed">
                                <Map className="w-12 h-12 text-gray-300 mx-auto mb-4" />
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">Feature Map</h3>
                                <p className="text-gray-500 max-w-md mx-auto mb-6 text-sm">
                                    A visual representation of the features and modules within this repository.
                                </p>
                            </div>
                        </div>
                    )}
...
async validateSession(token: string): Promise<User> {
  // ...
                        ...
                        <div className="p-8 space-y-4 animate-in fade-in duration-300">
                            ...
                            <div className="border border-gray-300 rounded-lg overflow-hidden bg-white shadow-sm">
                                ...
                                <div className="divide-y divide-gray-200">
                                    {[
                                        { id: 114, title: "Add /ping command for bot responsiveness checks", author: "Wirasn", date: "2 days ago", tasks: "2 of 4", comments: 0, status: "open" },
                                        { id: 112, title: "Workflow engine E2E test: Feature development workflow", author: "Wirasn", date: "2 days ago", comments: 1, status: "open" },
                                        { id: 108, title: "Add workflow engine for multi-step AI orchestration", author: "Wirasn", date: "2 days ago", tasks: "3 tasks done", comments: 0, status: "open" },
                                        { id: 107, title: "Add workflow engine for chaining AI prompts", author: "Wirasn", date: "2 days ago", tasks: "3 tasks done", comments: 0, status: "open" },
                                        { id: 95, title: "Add router workflow logging for observability", author: "Wirasn", date: "4 days ago", tasks: "3 tasks done", comments: 8, status: "open" },
                                        { id: 83, title: "Add OpenCode provider support", author: "Wirasn", date: "2 weeks ago", tasks: "3 tasks done", comments: 1, status: "open" },
                                        { id: 82, title: "Fix: Handle cloud database pooler idle disconnects gracefully", author: "BrewsterNZ", date: "2 weeks ago", comments: 0, status: "open" },
                                    ].map(pr => (
                                        <div key={pr.id} className="px-4 py-3 hover:bg-gray-50 group flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2">
                                                    <Link href={`/repositories/${repo.id}/pulls/${pr.id}`}>
                                                ...
                                                <div className="flex items-center gap-1.5 text-xs text-gray-500 mt-1">
                                                    ...
                                                    {pr.tasks && (
                                                        <span className="flex items-center gap-1 ml-1">
                                                            <div className="w-2.5 h-2.5 rounded-full border border-blue-500 relative flex items-center justify-center">
                        ...
                        <div className="p-8 space-y-6 animate-in fade-in duration-300">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm text-center">
                                    <div className="text-3xl font-bold text-sky-600 mb-1">2</div>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    {STAFFING_DATA.map((role) => (
                                        <Card key={role.id} className="overflow-hidden border border-gray-200">
                                                ...
                                                <div className="flex flex-col md:flex-row gap-6">
                                                    ...
                                                    <div className="flex-1 space-y-3">
                                                        <div className="flex items-center gap-3 flex-wrap">
                                                            <h4 className="font-bold text-gray-900">({role.id}) {role.title}</h4>
                                                            <span className="bg-emerald-700 text-white text-xs font-bold px-2 py-0.5 rounded">{role.level}</span>
                                                        </div>
                                                        <div className="flex gap-2 flex-wrap">
                                                            {role.skills.map((skill) => (
                                                                <span key={skill} className="px-2 py-1 bg-gray-100 border border-gray-200 rounded text-xs text-gray-600 font-medium">
                                                                    {skill}
                                                                </span>
                                                            ))}
                                                        </div>
                                            ...
                                            <ResponsiveContainer width="100%" height="100%">
                                                <PieChart>
                                                    <Pie
                                                        ...
                                                        dataKey="fte"
                                                    >
                                                        {TECHNOLOGIES_DATA.map((entry, index) => (
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <div className="flex items-baseline gap-2 mt-2">
                                                    ...
                                                    <span className="text-sm font-medium text-red-600">1 High</span>
                                                </div>
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-400 mt-1">Passing 9/12 checks</p>
                                            </div>
                            ...
                            <Card className="border-none shadow-sm ring-1 ring-gray-100">
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className="text-xs font-medium text-red-700 bg-red-50 border border-red-100 px-2 py-1 rounded">4 Issues Found</span>
                                    </div>
                                    <div className="space-y-3">
                                        {[
                                            { id: 'CVE-2023-1234', severity: 'High', package: 'axios', version: '0.21.1', desc: 'Server-Side Request Forgery via improperly sanitized URL parameters.' },
                                            { id: 'CVE-2023-5678', severity: 'Medium', package: 'lodash', version: '4.17.15', desc: 'Prototype Pollution vulnerability in merge function.' },
                                            { id: 'CVE-2023-9012', severity: 'Low', package: 'minimist', version: '1.2.0', desc: 'Exposure of sensitive information via correct error handling.' },
                                            { id: 'CVE-2023-3456', severity: 'Low', package: 'json5', version: '1.0.1', desc: 'Denial of Service via large JSON payload parsing.' },
                                        ].map((vuln, i) => (
                                            <div key={i} className="flex items-start justify-between p-4 bg-white border border-gray-100 rounded-lg shadow-sm">
                                                <div className="flex gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-600 leading-relaxed">{vuln.desc}</p>
                                                    </div>
                                                </div>
                                ...
                                <Card className="border-none shadow-sm ring-1 ring-gray-100">
                                    <CardContent className="p-6">
                                        ...
                                        <div className="space-y-2">
                                            {[
                                                { file: 'src/config/api.ts', line: 12, type: 'AWS Access Key', snippet: 'AKIA****************' },
                                                { file: 'docker-compose.yml', line: 45, type: 'DB Password', snippet: 'POSTGRES_PASSWORD=*****' },
                                            ].map((secret, i) => (
                                ...
                                <Card className="border-none shadow-sm ring-1 ring-gray-100">
                                    <CardContent className="p-6">
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            <span className="text-xs font-medium text-gray-500">9/12 Passed</span>
                                        </div>
                                        <div className="space-y-3">
                                            {[
                                                { label: 'HTTPS Enabled', passed: true },
                                                { label: 'Content Security Policy (CSP)', passed: true },
                                                { label: 'Docker Rootless Mode', passed: false },
                                                { label: 'Dependency Pinning', passed: true },
                                                { label: 'Rate Limiting Configured', passed: false },
                                                { label: 'Secure Headers (Helmet)', passed: true },
                                            ].map((check, i) => (
                                    ...
                                    <CardContent className="p-4">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-amber-600 mt-1">12 items</p>
                                            </div>
                                    ...
                                    <CardContent className="p-4">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-orange-600 mt-1">3.2%</p>
                                            </div>
                                            <div className="p-3 bg-orange-50 rounded-xl">
                                    ...
                                    <CardContent className="p-4">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-blue-600 mt-1">2.8 / 5</p>
                                            </div>
                                    ...
                                    <CardContent className="p-4">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-emerald-600 mt-1">67%</p>
                                            </div>
                            ...
                            <Card className="border-none shadow-sm ring-1 ring-gray-100">
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className="text-xs font-medium text-gray-400 bg-gray-100 px-2 py-1 rounded">12 unused items found</span>
                                    </div>
                                    <div className="space-y-2">
                                        {[
                                            { type: 'function', name: 'formatLegacyDate()', file: 'src/utils/dateHelpers.ts', line: 45 },
                                            { type: 'variable', name: 'DEPRECATED_API_URL', file: 'src/config/constants.ts', line: 12 },
                                            { type: 'import', name: 'lodash/merge', file: 'src/components/DataGrid.tsx', line: 3 },
                                            { type: 'function', name: 'calculateOldMetrics()', file: 'src/services/analytics.ts', line: 89 },
                                            { type: 'variable', name: 'tempDebugFlag', file: 'src/hooks/useAuth.ts', line: 22 },
                                            { type: 'function', name: 'renderLegacyTable()', file: 'src/components/Table.tsx', line: 156 },
                                        ].map((item, i) => (
                            ...
                            <Card className="border-none shadow-sm ring-1 ring-gray-100">
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className="text-xs font-medium text-gray-400 bg-gray-100 px-2 py-1 rounded">3 similar blocks found</span>
                                    </div>
                                    <div className="space-y-4">
                                        {[
                                            { similarity: 94, files: ['src/components/UserCard.tsx:45-62', 'src/components/ProfileCard.tsx:23-40'], lines: 18 },
                                            { similarity: 87, files: ['src/hooks/useApi.ts:12-28', 'src/hooks/useFetch.ts:8-24'], lines: 16 },
                                            { similarity: 82, files: ['src/utils/validation.ts:34-52', 'src/forms/validators.ts:12-30'], lines: 19 },
                                        ].map((block, i) => (
                            ...
                            <Card className="border-none shadow-sm ring-1 ring-gray-100">
                                <CardContent className="p-6">
                                    ...
                                    <div className="h-64">
                                        <ResponsiveContainer width="100%" height="100%">
                                            <BarChart data={[
                                                { name: 'UserService.ts', complexity: 4.2 },
                                                { name: 'DataGrid.tsx', complexity: 3.8 },
                                                { name: 'AuthContext.ts', complexity: 3.1 },
                                                { name: 'ApiClient.ts', complexity: 2.9 },
                                                { name: 'FormValidator.ts', complexity: 2.5 },
                                                { name: 'useTable.ts', complexity: 2.2 },
                                                { name: 'utils.ts', complexity: 1.8 },
                                                ...
                                                <Bar dataKey="complexity" radius={[0, 4, 4, 0]}>
                                                    {[4.2, 3.8, 3.1, 2.9, 2.5, 2.2, 1.8].map((val, index) => (
                                                        <Cell key={index} fill={val > 3.5 ? '#f59e0b' : val > 2.5 ? '#3b82f6' : '#22c55e'} />
                                                    ))}
                                                </Bar>
                                            </BarChart>
                                        </ResponsiveContainer>
                            ...
                            <Card className="border-none shadow-sm ring-1 ring-gray-100">
                                <CardContent className="p-6">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        ...
                                        <div className="h-48">
                                            <ResponsiveContainer width="100%" height="100%">
                                                <PieChart>
                                                    <Pie
                                                        data={[
                                                            { name: 'Covered', value: 67, fill: '#22c55e' },
                                                            { name: 'Uncovered', value: 33, fill: '#e5e7eb' },
                                                        ]}
                                                        innerRadius={50}
                                                        outerRadius={70}
                                                        dataKey="value"
                                        ...
                                        <div className="space-y-2">
                                            {[
                                                { folder: 'src/components', coverage: 82, files: 24 },
                                                { folder: 'src/hooks', coverage: 91, files: 8 },
                                                { folder: 'src/utils', coverage: 78, files: 12 },
                                                { folder: 'src/services', coverage: 45, files: 6 },
                                                { folder: 'src/pages', coverage: 34, files: 15 },
                                            ].map((item, i) => (
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-400 mt-1">18 internal, 6 external</p>
                                            </div>
                                            <div className="p-3 bg-blue-50 rounded-xl">
                                ...
                                <div className="flex-1 bg-gray-50">
                                    <ReactFlow
                                        defaultNodes={[
                                            ...
                                            { id: 'd3', position: { x: 400, y: 100 }, data: { label: 'Router' }, style: { background: '#fff', border: '1px solid #94a3b8', width: 140, borderRadius: 8, fontSize: 12 } },
                                            { id: 'd4', position: { x: 100, y: 250 }, data: { label: 'UserContext' }, style: { background: '#eff6ff', border: '1px solid #3b82f6', width: 140, borderRadius: 8, fontSize: 12 } },
                                            { id: 'd5', position: { x: 400, y: 250 }, data: { label: 'ProductView' }, style: { background: '#fff', border: '1px solid #94a3b8', width: 140, borderRadius: 8, fontSize: 12 } },
                                            { id: 'd6', position: { x: 250, y: 350 }, data: { label: 'API Client' }, style: { background: '#f5f3ff', border: '1px solid #8b5cf6', width: 140, borderRadius: 8, fontSize: 12 } },
                                            { id: 'd7', position: { x: 250, y: 450 }, data: { label: 'Utils' }, style: { background: '#f8fafc', border: '1px solid #64748b', width: 140, borderRadius: 8, fontSize: 12 } },
                                        ]}
                                        defaultEdges={[
                                            { id: 'e1-2', source: 'd1', target: 'd2', animated: true },
                                            { id: 'e1-3', source: 'd1', target: 'd3' },
                                            { id: 'e2-4', source: 'd2', target: 'd4', label: 'Circular?', labelStyle: { fill: 'red', fontWeight: 700 }, style: { stroke: 'red' } },
                                            { id: 'e4-2', source: 'd4', target: 'd2', style: { stroke: 'red' }, animated: true },
                                            { id: 'e3-5', source: 'd3', target: 'd5' },
                                            { id: 'e5-6', source: 'd5', target: 'd6' },
                                            { id: 'e2-6', source: 'd2', target: 'd6' },
                                        ...
                                        <div className="space-y-3">
                                            <div className="p-3 bg-red-50 border border-red-100 rounded-lg">
                                                ...
                                                <p className="text-xs text-red-600 mb-3 ml-4 leading-relaxed">
                                                    These two contexts reference each other, causing initialization issues and potential infinite loops during render.
                                                </p>
                                                <div className="ml-4 space-y-1">
                                                    <div className="flex items-center gap-2 text-xs text-gray-600 bg-white px-2 py-1 rounded border border-red-100">
                                                        <FileText className="w-3 h-3" /> src/context/AuthContext.tsx
                                                    </div>
                                                    <div className="flex items-center gap-2 text-xs text-gray-600 bg-white px-2 py-1 rounded border border-red-100">
                                                        <FileText className="w-3 h-3" /> src/context/UserContext.tsx
                                                    </div>
                                                </div>
                                            </div>

                                            <div className="p-3 bg-orange-50 border border-orange-100 rounded-lg">
                                                <div className="flex items-center gap-2 mb-2 text-orange-800 text-sm font-bold">
                                                    <span className="w-2 h-2 rounded-full bg-orange-500"></span>
                                                    ProductUtils ↔ PriceCalculator
                                                </div>
                                                <div className="ml-4 space-y-1">
                                                    <div className="flex items-center gap-2 text-xs text-gray-600 bg-white px-2 py-1 rounded border border-orange-100">
                                                        <FileText className="w-3 h-3" /> src/utils/product.ts
                                                    </div>
                                                    <div className="flex items-center gap-2 text-xs text-gray-600 bg-white px-2 py-1 rounded border border-orange-100">
                                                        <FileText className="w-3 h-3" /> src/helpers/price.ts
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="w-full text-sm text-left">
                                                ...
                                                <tbody className="divide-y divide-gray-100">
                                                    {[
                                                        { name: 'Button', exports: 3, usedBy: 42, maturity: 'High' },
                                                        { name: 'useAuth', exports: 1, usedBy: 16, maturity: 'High' },
                                                        { name: 'Card', exports: 5, usedBy: 28, maturity: 'Med' },
                                                        { name: 'formatDate', exports: 1, usedBy: 89, maturity: 'High' },
                                                        { name: 'ProductList', exports: 1, usedBy: 2, maturity: 'Low' },
                                                    ].map((row, i) => (
                                    ...
                                    {codeFlows.map((flow) => (
                                        <div
                                            ...
                                            onClick={() => {
                                                ...
                                                if (flow.status === 'completed') setFlowAnalysisState('result');
                                            }}
                                            className={cn(
                                                "p-4 rounded-xl border-2 transition-all cursor-pointer group",
                    ...
                    {!["overview", "team-staffing", "technologies", "complexity", "code-quality", "ask-questions", "prompt-generation", "code-flows"].includes(activeTab) && (
