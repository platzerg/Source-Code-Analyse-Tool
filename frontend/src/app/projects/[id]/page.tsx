                            ...
                            <div className="flex gap-6 overflow-x-auto pb-4">
                                {(['Todo', 'In Progress', 'Done'] as const).map((column) => (
                                    <div key={column} className="w-80 flex-shrink-0">
                                        <div className="flex items-center justify-between mb-4 bg-[#f6f8fa] p-3 rounded-lg border border-gray-200">
                                            <div className="flex items-center gap-2">
                                        ...
                                        <div className="space-y-4">
                                            {filteredTasks.filter(t => t.status === column).map(task => (
                                                <Card key={task.id} className="border-gray-200 shadow-sm hover:border-blue-300 hover:shadow transition-all cursor-move">
                                                    <CardContent className="p-4">
                                                        <div className="flex justify-between items-start mb-3">
                                                            <div className={cn(
                                                                "w-1 h-4 rounded-full",
                                                                task.priority === 'High' ? "bg-red-500" :
                                                                    task.priority === 'Medium' ? "bg-orange-500" : "bg-gray-300"
                                                            )} />
                                                            <span className="text-[10px] text-gray-400 font-medium">#{task.id}</span>
                                                        </div>
                                                        <p className="text-sm font-medium text-gray-900 mb-4">{task.title}</p>
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                <div className="p-1 bg-gray-50 rounded border border-gray-100" title={task.assignee}>
                                            ...
                                            <button
                                                onClick={handleAddTask}
                                                className="w-full py-2 flex items-center justify-center gap-1.5 text-gray-500 hover:text-gray-900 hover:bg-[#f6f8fa] rounded-lg transition-all text-sm font-medium"
                                            >
